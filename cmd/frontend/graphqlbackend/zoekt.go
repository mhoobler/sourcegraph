...
func zoektSearchReposOnly(ctx context.Context, client backend.StreamSearcher, query zoektquery.Q, db dbutil.DB, c Sender, getRepoRevMap func() map[string]*search.RepositoryRevisions) error {
